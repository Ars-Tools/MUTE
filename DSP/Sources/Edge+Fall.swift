...
extension Edge.Fall.Xe: Publisher {
...
public func edge(fall source: Stream) -> some Stream & Effect & Publisher<CMTime, Never> {
	Edge.Fall.Xe(signal: source, notify: .init())
}
